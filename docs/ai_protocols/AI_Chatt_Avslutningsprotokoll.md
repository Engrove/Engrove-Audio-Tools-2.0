...
```
---
## ARKIVERAD — använd inte
*Denna canvas är arkiverad. Aktiv version: **AI_Chatt_Avslutningsprotokoll (v4.1 – konsoliderad, utan A, med P‑HR v2.2)**.*
...
**NYTT:** Inkludera en lista över alla `heuristicId` som aktiverades under sessionen.
...
```json
{
  ...
  "detailedMetrics": {
    ...
    "heuristicsTriggered": [ "H-YYYYMMDD-seqA", "H-YYYYMMDD-seqB" ]
  },
